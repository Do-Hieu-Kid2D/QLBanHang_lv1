...
text = sys.argv[1]										#lấy dữ liệu truyền vào từ tham số dòng lệnh, đây là văn bản cần chuyển sang âm thanh

													#Auto chơi tiếng việt
byte_array = ("vi"+'@'+text).encode("utf-8")		#chuyển đầu vào thành mảng các byte, vì md5 yêu cầu thế
...
if not os.path.exists(fn):								#NẾU CHƯA TỒN TẠI FILE THÌ MỚI CẦN GTTS SINH RA MP3
	try:												#bẫy lỗi
		tts = gTTS(text, lang="vi", slow=False)		#gọi thư viện để chuyển văn bản trong txt -> sang dạng âm thanh
